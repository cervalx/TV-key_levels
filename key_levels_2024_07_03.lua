...
levels_QQQ.put(5462,'if quants min breaks' )
levels_QQQ.put(5465,'if quants min breaks' )
levels_QQQ.put( id be looking here. ,'' )
...
levels_SPX.put(481.5,'if min breaks' )
levels_SPX.put( look here for support imo. ,'' )
levels_SPX.put(481,'' )
