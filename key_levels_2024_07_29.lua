...
levels_QQQ.put(5545,'' )
levels_QQQ.put(5535,'stronger resistance' )
levels_QQQ.put(5525,'' )
levels_QQQ.put(5505,'' )
...
levels_QQQ.put(5480,'' )
levels_QQQ.put(5470,'' )
levels_QQQ.put(5450,'strong level support level, with 50HR MA.' )
levels_QQQ.put(5435,'min' )
levels_QQQ.put(5421,'' )
// Add levels and comments for SPX
levels_SPX.put(473,'' )
levels_SPX.put(471,'' )
levels_SPX.put(470,'quant max' )
levels_SPX.put(469,'' )
levels_SPX.put(467.7,'' )
levels_SPX.put(465 ,'' )
levels_SPX.put(463,'key level' )
levels_SPX.put(462.3,'relates to 19k on NASDAq, will be a key level.' )
levels_SPX.put(461,'' )
levels_SPX.put(460,'min' )
levels_SPX.put(458.8,'' )
